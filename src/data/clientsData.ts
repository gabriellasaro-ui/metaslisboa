...
export const squadsData: Squad[] = [
  {
    ...
    clients: [
      ...
      { name: "Festival Volta ao Mundo", hasGoal: "NAO", notes: "Churn" },
      { name: "Guardião Consultoria", hasGoal: "NAO", notes: "Aviso prévio, possível reajuste de fee" },
      { name: "Kit Lanche Gostosuras", hasGoal: "SIM", goalType: "OUTROS", goalValue: "Leads mais qualificados" },
      { name: "Supermercado Silvana", hasGoal: "NAO", notes: "Churn" },
      { name: "Buffet Encanto e Magia", hasGoal: "SIM", goalType: "Leads", goalValue: "Leads mais qualificados" },
      { name: "Dfibra", hasGoal: "NAO" },
      { name: "DISTRIFERRO", hasGoal: "NAO" },
  ...
  },
  {
    ...
    clients: [
      ...
      { name: "Fortfill", hasGoal: "NAO" },
      { name: "Altxs", hasGoal: "NAO", notes: "Cliente em aviso prévio" },
      { name: "Consórcio Nanuque", hasGoal: "NAO" },
      { name: "Toolbox", hasGoal: "NAO" },
      { name: "QuebraMar", hasGoal: "NAO" },
    ]
  },
  {
    name: "MIDAS",
